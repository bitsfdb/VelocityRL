...
def issue_leaf(ca_cert: x509.Certificate, ca_key: rsa.RSAPrivateKey, host: str) -> None:
    ...
    if host == "epic":
        ...
        san_list = [
            ...
            x509.DNSName("*.on.epicgames.com"),
            x509.DNSName("*.launcher.epicgames.com"),
            x509.DNSName("*.store.epicgames.com"),
            ...
            x509.DNSName("live.psynet.gg"),
            x509.DNSName("*.rlpp.psynet.gg"),
            x509.DNSName("*.psynet.gg"),
            x509.DNSName("psynet.gg"),
            x509.DNSName("*.unrealengine.com"),
            x509.DNSName("*.arkoselabs.com"),
            x509.DNSName("*.hcaptcha.com"),
            x509.DNSName("accounts.epicgames.com"),
            x509.DNSName("tracking.epicgames.com"),
            x509.DNSName("static-assets-prod.epicgames.com"),
            x509.DNSName("launcher-website-prod07.ol.epicgames.com"),
            x509.DNSName("account-public-service-prod.ol.epicgames.com"),
            x509.DNSName("account-public-service-prod03.ol.epicgames.com"),
            x509.DNSName("api.epicgames.dev"),
            x509.DNSName("identity.epicgames.com"),
            x509.DNSName("ec-captcha.epicgames.com"),
